...
VALUES
    ...
    (41, 'Creed Silver Mountain Water', 'Top: Bergamot, Mandarin. Heart: Green Tea, Blackcurrant. Base: Musk, Sandalwood, Petitgrain.', 'Cold air and green tea over a clean musk. Alpine rather than aquatic, and far more interesting than most fresh scents.', '100 ml', 7, 'creed_silver_mountain_water.jpg', 48000.00, 0, 1),
    ...
    (49, 'Rayhaan Ghala Zayed Luxury Gold', 'Top: Bergamot, Saffron. Heart: Rose, Patchouli, Oud. Base: Amber, Musk, Sandalwood.', 'Rich, golden and unapologetically sweet. Built for cold evenings and long nights.', '100 ml', 26, 'rayhaan_ghala_zayed_luxury_gold.jpg', 6240.00, 0, 1),
    (50, 'Afnan 9PM', 'Top: Apple, Cinnamon, Lavender. Heart: Vanilla, Tonka Bean, Orange Blossom. Base: Amberwood, Praline, Patchouli.', 'Apple and cinnamon over praline. The bottle that made Afnan a household name outside the Gulf.', '100 ml', 55, 'afnan_9pm.jpg', 4800.00, 1, 1),
    ...
    (52, 'Afnan Turathi Blue', 'Top: Bergamot, Grapefruit. Heart: Lavender, Geranium. Base: Amberwood, Musk, Cedar.', 'A clean blue fragrance with a woody-amber spine. Straightforward, and very easy to reach for.', '90 ml', 38, 'afnan_turathi_blue.jpg', 4320.00, 0, 1),
    ...
    (54, 'Versace Dylan Blue', 'Top: Bergamot, Grapefruit, Fig Leaf. Heart: Violet Leaf, Papyrus, Patchouli. Base: Musk, Tonka Bean, Saffron.', 'Fig leaf and grapefruit with a mineral edge. The most wearable thing the house has made in years.', '100 ml', 28, 'versace_dylan_blue.jpg', 12600.00, 0, 1),
    ...
    (56, 'Yves Saint Laurent Y Eau De Parfum', 'Top: Apple, Ginger, Bergamot. Heart: Sage, Juniper, Geranium. Base: Amberwood, Tonka Bean, Cedar.', 'Crisp apple and sage over amberwood. Sharp, modern and cut for a suit.', '100 ml', 24, 'yves_saint_laurent_y_eau_de_parfum.jpg', 16200.00, 0, 1),
    ...
    (60, 'Giorgio Armani Code Parfum', 'Top: Green Apple, Bergamot. Heart: Orange Blossom, Tonka Bean. Base: Tobacco, Leather, Amber.', 'Tobacco and tonka under bright apple. Warm, tailored, and made for a room with low lighting.', '100 ml', 20, 'giorgio_armani_code_parfum.jpg', 14400.00, 0, 1),
    ...
    (65, 'Lattafa Yara', 'Top: Orchid, Heliotrope. Heart: Tuberose, Gourmand Notes. Base: Vanilla, Musk, Sandalwood.', 'Creamy tuberose and vanilla. Sweet, soft and everywhere for good reason.', '100 ml', 60, 'lattafa_yara.jpg', 3360.00, 0, 1),
    ...
    (68, 'Armaf Ventana Pour Homme', 'Top: Bergamot, Pineapple, Apple. Heart: Birch, Jasmine. Base: Vanilla, Musk, Ambergris.', 'Fruity and smoky in equal measure. An easy everyday bottle that never feels cheap.', '100 ml', 30, 'armaf_ventana_pour_homme.jpg', 5040.00, 0, 1),
    (69, 'Kilian Black Phantom', 'Top: Rum, Coffee. Heart: Caramel, Sugar Cane, Almond. Base: Sandalwood, Dark Chocolate, Patchouli.', 'Rum, coffee and dark chocolate. A pirate skull on the bottle, and a genuinely serious gourmand inside.', '50 ml', 7, 'kilian_black_phantom.jpg', 32400.00, 0, 1),
    (70, 'Givenchy Gentleman Society', 'Top: Vetiver, Bergamot. Heart: Iris, Cardamom, Sage. Base: Vanilla, Patchouli, Cedar.', 'Iris and vetiver with a vanilla softness underneath. The most grown-up Gentleman yet.', '100 ml', 23, 'givenchy_gentleman_society.jpg', 14400.00, 0, 1),
