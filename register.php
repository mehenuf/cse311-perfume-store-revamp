...
<div class="shell auth-wrap">
    <div class="panel auth-card" style="max-width:620px">
        ...
        <?php
        // Repopulate whatever the visitor already typed after a rejected
        // submission, so a taken username doesn't mean retyping all 8 fields.
        ...
        <form action="functions/authcode.php" method="post" class="form-grid form-grid--2">
            ...
            <div class="field">
                ...
                <input class="input" id="rg-password" name="password" type="password" required
                       ...
                       aria-describedby="rg-password-hint">
                <span class="field__hint" id="rg-password-hint">At least 8 characters.</span>
            </div>
            ...
            <div class="field">
                ...
                <input class="input" id="rg-repassword" name="repassword" type="password" required
                       ...
                       data-confirm-password="rg-password">
            </div>
        ...
        <p style="margin-top:var(--s-5);padding-top:var(--s-4);border-top:1px solid var(--line);color:var(--fg-muted);font-size:var(--t-sm)">
            Already have an account? <a class="auth-link" href="login.php" style="color:var(--gold);font-weight:600">Log in</a>
        </p>
    </div>
</div>
